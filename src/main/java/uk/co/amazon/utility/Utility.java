...
//***************************** Is Display Methods **********************************************//
    ...
    /**
     * Drags and drops a slider by a given offset.
     *
     * @param driver WebDriver instance
     * @param slider WebElement representing the slider
     * @param xOffset Horizontal offset to drag the slider
     */
    public static void dragAndDropBy(WebDriver driver, WebElement slider, int xOffset) {
        Actions actions = new Actions(driver);
        actions.dragAndDropBy(slider, xOffset, 0).perform();
    }

    /**
     * Drags and drops a slider to a specific value.
     *
     * @param driver WebDriver instance
     * @param slider WebElement representing the slider
     ...
     */
    public static void setSliderValue(WebDriver driver, WebElement slider, int value, int maxValue) {
        int sliderWidth = slider.getSize().width;
        int offset = (int) ((value / (double) maxValue) * sliderWidth);
        dragAndDropBy(driver, slider, offset);
    }
